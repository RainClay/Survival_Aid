...
/* JADX INFO: loaded from: carpet-survival-aid-mc1.21.11-1.0.1.jar:com/survivalaid/SurvivalAidCommands.class */
public final class SurvivalAidCommands {
    ...
    public static void register(CommandDispatcher<class_2168> dispatcher) {
        dispatcher.register(class_2170.method_9247("survivalaid").requires(source -> {
            return source.method_75037().hasPermission(new class_12087.class_12089(class_12094.field_63198));
