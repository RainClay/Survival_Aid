...
/* JADX INFO: loaded from: carpet-survival-aid-mc1.21.11-1.0.1.jar:com/survivalaid/SurvivalAidTntLikeBlocks.class */
public final class SurvivalAidTntLikeBlocks {
        ...
        while (iterator.hasNext()) {
            ...
            if (primedBlock.entity.method_31481()) {
                ...
                if (primedBlock.fuse <= 0) {
                    class_1937 world = primedBlock.entity.method_73183();
    ...
    /* JADX INFO: loaded from: carpet-survival-aid-mc1.21.11-1.0.1.jar:com/survivalaid/SurvivalAidTntLikeBlocks$PrimedBlock.class */
