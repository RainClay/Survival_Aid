...
public final class SurvivalAidCommands {
    ...
    public static void register(CommandDispatcher<ServerCommandSource> dispatcher) {
        ...
        }).then(CommandManager.literal("pickup").then(CommandManager.literal("allow").then(CommandManager.argument("item", StringArgumentType.word()).then(CommandManager.argument("player", StringArgumentType.word()).executes(context -> {
