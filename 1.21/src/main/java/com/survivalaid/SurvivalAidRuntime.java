...
/* JADX INFO: loaded from: carpet-survival-aid-mc1.21-1.0.1.jar:com/survivalaid/SurvivalAidRuntime.class */
public final class SurvivalAidRuntime {
    ...
    private static void handleAutoEatFood(MinecraftServer server, class_3222 player) {
        if (!AutoEatFoodRule.survivalAidAutoEatFood || player.method_7337() || player.method_7325() || player.method_29504()) {
            debugAutoEat(server, player, "跳过：规则=" + AutoEatFoodRule.survivalAidAutoEatFood + "，创造=" + player.method_7337() + "，旁观=" + player.method_7325() + "，死亡=" + player.method_29504());
            return;
        }
        UUID playerId = player.method_5667();
        int currentTick = server.method_3780();
        ...
        int currentFoodLevel = player.method_7344().method_7586();
                ...
                if (stack.method_31574(class_1802.field_8367)) {
                    ...
                    if (foodComponent == null) {
                        ...
                        if (currentFoodLevel <= threshold) {
                            player.method_7344().method_7579(foodComponent);
                            ...
                            stack.method_7934(1);
                            player.method_7353(class_2561.method_43470("自动进食：已吃 " + stack.method_7964().getString() + "。"), true);
                            return;
                        }
                    }
                }
