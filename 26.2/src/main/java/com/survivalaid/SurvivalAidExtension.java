...
public class SurvivalAidExtension implements CarpetExtension, ModInitializer {
    ...
    public void onInitialize() {
        ...
        PayloadTypeRegistry.clientboundPlay().register(SearchItemRequestPayload.TYPE, SearchItemRequestPayload.CODEC);
        PayloadTypeRegistry.serverboundPlay().register(SearchItemResultPayload.TYPE, SearchItemResultPayload.CODEC);
